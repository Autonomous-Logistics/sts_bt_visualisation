...
class Graph(Shape):
    ...
    def __init__(self, width=1, height=1, shapes=(), nodes=(), edges=()):
        ...
        self.nodes = nodes
        self.edges = edges
        self.nodesDict = {n.id : n for n in self.nodes}
    ...
    ### Nick Fiege:
    def updateNodeBorderColor(self, node, color):
        self.nodesDict[node].shapes[0].pen.color = color
    def updateNodeTextColor(self, node, color):
        self.nodesDict[node].shapes[1].pen.color = color
